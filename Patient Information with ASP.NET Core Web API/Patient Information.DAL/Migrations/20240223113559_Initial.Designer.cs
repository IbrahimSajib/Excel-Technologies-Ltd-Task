...
namespace Patient_Information.DAL.Migrations
{
    ...
    [Migration("20240223113559_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.Allergies", b =>
                {
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.AllergiesDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.Diseases", b =>
                {
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.NCD", b =>
                {
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.NCD_Details", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.Patient", b =>
                {
                    b.Property<int>("PatientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.AllergiesDetails", b =>
                {
                    b.HasOne("Patient_Information.BL.Models.Allergies", "Allergies")
                        .WithMany("AllergiesDetails")
                        .HasForeignKey("AllergiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Patient_Information.BL.Models.Patient", "Patient")
                        .WithMany("AllergiesDetails")
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.NCD_Details", b =>
                {
                    b.HasOne("Patient_Information.BL.Models.NCD", "NCD")
            ...
            modelBuilder.Entity("Patient_Information.BL.Models.Patient", b =>
                {
                    b.HasOne("Patient_Information.BL.Models.Diseases", "Diseases")
                        .WithMany("Patients")
